...
<table class="table">
    <thead>
        <tr>
            <th scope="col">
                <a
                    href="?elem=menu&page=<?= $page ?>&sort=id&order=<?= $sort === 'id' && $order === 'ASC' ? 'desc' : 'asc' ?>">
                    Id <?= $sort === 'id' ? ($order === 'ASC' ? '↑' : '↓') : '' ?>
                </a>
            </th>
            <th scope="col">
                <a
                    href="?elem=menu&page=<?= $page ?>&sort=firstname&order=<?= $sort === 'firstname' && $order === 'ASC' ? 'desc' : 'asc' ?>">
            ...
            <th scope="col">
                <a
                    href="?elem=menu&page=<?= $page ?>&sort=date&order=<?= $sort === 'date' && $order === 'ASC' ? 'desc' : 'asc' ?>">
